        ...
        [ div [ class "app-container", Styles.appContainer model.listVisible ]
            [ header [ class "app-header" ]
                ...
                , div [ class "app-header__buttons" ]
                    [ button [ class "app-header__buttons__btn btn btn-text", onClick SwitchColorTheme ]
                        [ text "Switch theme" ]
                    , button [ class "app-header__buttons__btn btn btn-control-point", onClick AddNewNote ]
                        [ i [ class "material-icons" ] [ text "control_point" ] ]
                    , button [ class "app-header__buttons__btn btn btn-list", onClick ToggleNoteList ]
